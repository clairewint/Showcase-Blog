	...
	<div class="row">
		...
		<div class="col-md-6 col-md-offset-3 comments-section">
			...
			<?php if (isset($user_id)): ?>
                        <form class="clearfix" action="commentView.php" method="post" id="comment_form">
			...
			<?php if (isset($comments)): ?>
				...
				<div class="comment clearfix">
					...
					<!-- reply form -->
					<form action="post_details.php" class="reply_form clearfix" id="comment_reply_form_<?php echo $comment['comm_ID'] ?>" data-id="<?php echo $comment['comm_ID']; ?>">
						...
						<?php if (isset($replies)): ?>
							<?php foreach ($replies as $reply): ?>
								...
								<div class="comment reply clearfix">
									<img src="profile.png" alt="" class="profile_pic">
									<div class="comment-details">
										<span class="comment-name"><?php echo getUsernameById($reply['2']) ?></span>
