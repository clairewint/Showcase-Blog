...
<div class="view-all">
    <ul>
        <li>  <h3>Get cooking...   </h3></li>
        <li> <a href=""><p>View all <i class="fa fa-angle-right"></i></p></a></li> 
                </ul>
</div>
                <section class="main-section">
                    ...
                    <div class="card">
                        <a href="#"> </a>
                        <img  class="card-img-top" alt="..." src="https://goodonyou.eco/wp-content/uploads/2020/03/Work-Home-TipsTN-768x1024.jpg"/> 
                        <div class="card-body">
